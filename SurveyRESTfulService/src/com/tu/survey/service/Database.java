...
public class Database {
	...
	private static final String SUBMITTED_SURVEYS_FILE_NAME = "D:\\submited_surveys.json";
	...
	public static void saveSurvey(Survey survey) throws JsonGenerationException, JsonMappingException, IOException {
		ObjectMapper mapper = new ObjectMapper();
		Surveys allSubmitedSurveys = mapper.readValue(new File(SUBMITTED_SURVEYS_FILE_NAME), Surveys.class);
		allSubmitedSurveys.addSurvey(survey);

		mapper.writeValue(new File(SUBMITTED_SURVEYS_FILE_NAME), allSubmitedSurveys);		
	}
}
